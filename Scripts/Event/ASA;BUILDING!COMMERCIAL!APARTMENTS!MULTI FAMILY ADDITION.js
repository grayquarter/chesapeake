...
// DISABLED: ASA:Building/Commercial/Apartments/Multi Family Addition:01 - script 49
...
if (publicUser) {
	updateFee('BLD_COM_010', 'BLD_APT_ADDTN', 'FINAL', AInfo['Square Footage'], 'Y');
	updateFee('BLD_COM_050', 'BLD_APT_ADDTN', 'FINAL', '.02', 'Y');
}
