...
if (AInfo['System Will Be'] == 'New' && (AInfo['System Type'] == 'Fire Alarm/Detection' || AInfo['System Type'] == 'Sprinkler System') && taskStatus('Application Submittal') == 'Accepted') {
	editTaskDueDate('Plan Review', dateAdd(taskStatusDate('Application Submittal'), 30));
}

// DISABLED: ASIUA:Building/Commercial/Trade/Fire:10 - script 5
...
// DISABLED: ASIUA:Building/Commercial/Trade/Fire:11 - script 5
...
// DISABLED: ASIUA:Building/Commercial/Trade/Fire:12 - script 5
