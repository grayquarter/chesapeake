...
if (wfTask == 'Permit Issuance' && (wfStatus == 'Ready to Issue' || wfStatus == 'Issued') && (appHasCondition('Building Permit', 'Applied', 'Asbestos Report is Required', null) || appHasCondition('Building Permit', 'Pending', 'Asbestos Report is Required', null))) {
	showMessage = true;
...
// DISABLED: WTUB:Building/Commercial/Addition/NA:45 - script 78
