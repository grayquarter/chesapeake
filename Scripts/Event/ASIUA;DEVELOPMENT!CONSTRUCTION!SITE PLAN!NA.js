...
// DISABLED: ASIUA:Development/Construction/Site Plan/NA:05 - script 134
// var childIds = getChildren('Utilities/Utility Activation/NA/NA');
// DISABLED: ASIUA:Development/Construction/Site Plan/NA:06 - script 134
// if (!isEmpty(childIds)) {
...
for (var i in siblings)
	aa.appSpecificInfo.editSingleAppSpecific(siblings[i], 'Bond Amount', AInfo['Utility Defect Bond Amount'], 'DEFECT BOND INFORMATION');
